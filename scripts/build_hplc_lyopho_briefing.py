...
nav:"← → 翻页",
tag:"内部汇报",
s1t:"PDF 厂房 HPLC 与冻干机改造",s1s:"进展 · 投资 · 周期",s1m:"",
s2t:"执行摘要",s2s:"",
...
s1t:"PDF HPLC & Lyophilizer Scheme",s1s:"Progress · Investment · Programme",s1m:"",
...
<h1>${t("s1t")}</h1><h2>${t("s1s")}</h2>${t("s1m")?`<p style="color:var(--muted);margin-top:1rem;font-size:.9rem">${t("s1m")}</p>`:""}</section>
