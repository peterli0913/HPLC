...
p2r2n:"HPLC + 冻干", p2r2s:"既有 PDF  footprint 改造", p2r2o:"£5.36M", p2r2d:"2027-09 HPLC / 12 月冻干",
...
hplc6kOom:"OOM 总价", hplc6kBase:"直接工程费（含 25%）", hplc6kRisk:"其他费及 OOM 预备费",
...
p2r2n:"HPLC + lyophilizer", p2r2s:"Retrofit in existing PDF", p2r2o:"£5.36M", p2r2d:"HPLC Sep 2027 / lyoph Dec",
...
hplcK2:"£5.36M", hplcK2d:"Project OOM",
...
hplc6kOom:"Total OOM", hplc6kBase:"Direct works (incl. 25%)", hplc6kRisk:"Other costs & OOM contingency",
