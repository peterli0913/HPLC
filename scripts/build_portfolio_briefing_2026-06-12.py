#!/usr/bin/env python3
"""Portfolio briefing 2026-06-12: extension + retrofit + C1 OEB5 upgrade."""
...
OUT = Path("/workspace/汇报/UK-PDF-Portfolio/UK_PDF_Portfolio_Briefing_2026-06-12.html")
...
.tag.ext{background:var(--ext)} .tag.hplc{background:var(--hplc)} .tag.c1{background:var(--c1)}
...
.kpi.ext{border-left-color:var(--ext)} .kpi.hplc{border-left-color:var(--hplc)} .kpi.c1{border-left-color:var(--c1)}
...
.decision-list li.ext{border-left-color:var(--ext)} .decision-list li.hplc{border-left-color:var(--hplc)} .decision-list li.c1{border-left-color:var(--c1)}
...
const GANTT_C1 = ''' + json.dumps(GANTT_C1) + r''';
''' + EXT_COST_RENDER_JS + HPLC_COST_RENDER_JS + C1_COST_RENDER_JS + r'''
...
p1t:"凯莱英 UK · Sandwich PDF", p1s:"资本项目汇报", p1m:"B902 东侧扩建 + 厂房内 HPLC/冻干改造 + C1 模块 OEB5 升级 · 2026年6月",
p2t:"项目概览", p2s:"三条独立工作流 · 可行性/内部估算 OOM",
...
p2r3n:"C1 模块 OEB5 升级", p2r3s:"现有 C1 模块 OEB5 日常运行能力", p2r3o:"£2.48M", p2r3d:"2027-07 安装确认",
...
p1t:"Asymchem UK · Sandwich PDF", p1s:"Capital Projects Briefing", p1m:"B902 extension + HPLC/lyoph retrofit + C1 OEB5 upgrade · June 2026",
p2t:"Project overview", p2s:"Three workstreams · feasibility / internal OOM",
...
p2r3n:"C1 module OEB5 upgrade", p2r3s:"Routine OEB5 ops in existing C1 module", p2r3o:"£2.48M", p2r3d:"IQ complete Jul 2027",
...
<div class="callout">${t("p2link")}</div></div></section>
