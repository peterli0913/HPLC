...
s5oom:"OOM 总价（可行性量级）",
s6t:"投资结构",s6s:"与 CM-0001 费用结构一致",chartLeft:"项目 OOM 三板块",chartRight:"直接工程费 — 分项",
...
s6t:"Investment structure",s6s:"Aligned to CM-0001 cost plan",chartLeft:"Project OOM — three blocks",chartRight:"Direct works — line items",
